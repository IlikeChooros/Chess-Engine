...
namespace chess
{
    ...
    public:
        ...
        constexpr static int MAX_ENDGAME_FACTOR =
            2*(ENDGAME_FACTOR_PIECES[0] + ENDGAME_FACTOR_PIECES[1] * 4 + ENDGAME_FACTOR_PIECES[2] +
            ENDGAME_FACTOR_PIECES[3] * 4 + ENDGAME_FACTOR_PIECES[4] * 2 + ENDGAME_FACTOR_PIECES[5] * 2);
